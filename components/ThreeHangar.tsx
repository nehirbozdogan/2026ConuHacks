      ...
      */}
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-end pb-32 px-6 text-center pointer-events-none">
        <div className="mb-4 flex flex-col items-center">
          ...
          */}
          <h3 className="text-5xl md:text-8xl font-bold tracking-tighter text-white drop-shadow-[0_0_80px_rgba(255,255,255,0.4)] select-none uppercase italic leading-none transform translate-y-[38px]">
            SKYBOUND
          </h3>
          <div className="h-4" />
        </div>
